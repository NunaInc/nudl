...
//
#ifndef NUDL_CONVERSION_PSEUDO_CONVERTER_H__
#define NUDL_CONVERSION_PSEUDO_CONVERTER_H__
...
class PseudoConvertState;

class PseudoConverter : public Converter {
 public:
  PseudoConverter();
 ...
 protected:
  ...
  absl::Status ConvertFunction(analysis::Function* fun,
                               ConvertState* state) const;
  absl::Status ConvertBindings(analysis::Function* fun,
                               ConvertState* state) const;
};
...
#endif  // NUDL_CONVERSION_PSEUDO_CONVERTER_H__
