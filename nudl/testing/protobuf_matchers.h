...
// ========
//
//   using ::nudl::EqualsProto;
//   using ::nudl::EquivToProto;
//   using ::nudl::proto::Approximately;
//   using ::nudl::proto::Partially;
//   using ::nudl::proto::WhenDeserialized;
//
...
class ProtoStringMatcher : public ProtoMatcherBase {
 public:
  ProtoStringMatcher(
      const std::string& expected,  // The text representing the expected proto.
      bool must_be_initialized,     // Must the argument be fully initialized?
      const ProtoComparison comp)   // How to compare the two protobufs.
...
// (using google::protobuf::util::MessageDifferencer::IgnoreField).
...
// field in m.
// See google::protobuf::MessageDifferencer::TreatAsSet() for more details.
template <class InnerProtoMatcher>
